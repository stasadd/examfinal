...
class Customers extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface
{
    ...
    {
//        $this->password_hash.Yii::$app->params['SALT'],PASSWORD_ARGON2I
    ...
    {
        return $this->hasMany(CustomerProduct::className(), ['customer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Products::className(), ['id' => 'product_id'])->viaTable('customer_product', ['customer_id' => 'id']);
    }
